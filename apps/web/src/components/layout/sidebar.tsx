...
const navItems = [
  ...
  { href: "/mid-term-strategy", label: "📈 中期戦略（Threads/IG）", icon: TrendingUp },
  { href: "/mentor",     label: "X運用（メンター/アルゴリズム）", icon: Sparkles },
  ...
  { href: "/affiliate/links",     label: "アフィリエイトリンク",   icon: Link2 },
  ...
  { href: "/monitoring", label: "予約監視",         icon: Activity },
